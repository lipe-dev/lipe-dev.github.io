...
tags: [ideas, react, github-actions, next, github-pages]
growth: evergreen
...
- **Next.js project**: With [[Next.js]], you will need to know about the `build` and `export` scripts, that will make the website ready for deploy.
