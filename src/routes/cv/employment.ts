export default [
	{
		...
		description: `
		Primary front-end developer on internal project (internal-platform.example.com), replacing the client's automotive division' legacy internal tooling for bulk vehicle listings. Built most front-end independently in a team under engineering management. Supports ~1,000 dealers, 50k+ vehicles, 1M+ photos. Ongoing migration (Wave 9/28).
		`,
		stack: [
			'React',
			'TypeScript',
		...
		challenges: [
			...
			'Extended @client-internal/ui-core-react and @client-internal/skin with custom styling; added Testing Library + Playwright coverage in Jenkins.'
		]
	},
	{
		name: 'LogRock',
